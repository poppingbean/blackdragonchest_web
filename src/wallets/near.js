...
export class Wallet {
   ...
   */
  constructor({ networkId = 'testnet', createAccessKeyFor = "blackdragonchest.testnet" }) {
  ...
  getSelectedWalletId = () => {
    return this.selectedWalletId; // Return the selected wallet ID
  };
  
  getAccounts = () => {
    return this.accounts; // Return the selected wallet ID
  };

  getKeyStore = (networkId, accountId) => {
